...
if ( ! preg_match("/^[!-~]+$/", $_POST['passwd'] )) $error .='パスワードに使えない文字が含まれています。<br>';
...
if ( $_POST['year'] == '') $error .='年が入力されていません。<br>';
if ( $_POST['month'] == '') $error .='月が入力されていません。<br>';
if ( $_POST['day'] == '') $error .='日が入力されていません。<br>';

if ( $_POST['postal1'] == '') $error .='郵便番号が入力されていません。<br>';
if ( $_POST['postal2'] == '') $error .='郵便番号が入力されていません。<br>';

if ( $_POST['xmpf'] == '') $error .='都道府県が選択されていません。<br>';

if ( $_POST['address1'] == '') $error .='住所１が入力されていません。<br>';
if ( $_POST['address2'] == '') $error .='住所２が入力されていません。<br>';
